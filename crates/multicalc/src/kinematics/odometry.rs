...
use crate::kinematics::diff_drive::ChassisDelta;
...
/// `pose · exp([Δs, 0, Δθ])`.
///
/// Assumes the chassis twist is constant across the tick (a zero-order hold on the wheel rates).
