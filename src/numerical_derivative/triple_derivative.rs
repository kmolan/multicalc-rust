...
/// 
/// assert!(f64::abs(val.unwrap() - 24.0) < 0.00001);
/// ```
/// 
...
///``` 
/// 
pub fn get_partial<T: ComplexFloat, const NUM_VARS: usize>(func: &dyn Fn(&[T; NUM_VARS]) -> T, idx_to_derivate: &[usize; 3], point: &[T; NUM_VARS], step: f64) -> Result<T, ErrorCode>
{
