use std::vec::Vec;
use crate::vec::numerical_integration::mode::IntegrationMethod;
use crate::vec::numerical_integration::single_integration;
use crate::vec::numerical_integration::double_integration;
...
fn test_booles_integration_1()
{
    ...
    let val = single_integration::get_total_custom(IntegrationMethod::Booles, &func, &integration_limit, 100).unwrap();
...
{ 
    ...
    let val = single_integration::get_partial_custom(IntegrationMethod::Booles, &func, 0, &integration_limit, &point, 100).unwrap();
    ...
    let val = single_integration::get_partial_custom(IntegrationMethod::Booles, &func, 1, &integration_limit, &point, 100).unwrap();
    ...
    let val = single_integration::get_partial_custom(IntegrationMethod::Booles, &func, 2, &integration_limit, &point, 100).unwrap();
...
fn test_booles_integration_3()
{
    ...
    let val = double_integration::get_total_custom(IntegrationMethod::Booles, &func, &integration_limits, 20).unwrap();
...
fn test_booles_integration_4()
{
    ...
    let point = std::vec![1.0, 1.0, 1.0];

    //double partial integration for first x then y, expect a value of ~1.50
    let val = double_integration::get_partial_custom(IntegrationMethod::Booles, &func, [0, 1], &integration_limits, &point, 20).unwrap();
...
fn test_gauss_legendre_quadrature_integration_1()
{
    ...
    let val = single_integration::get_total_custom(IntegrationMethod::GaussLegendre, &func, &integration_limit, 2).unwrap();
...
fn test_gauss_legendre_quadrature_integration_2()
{
    ...
    //partial integration for x, known to be x*x + x*y*z, expect a value of ~7.00
    let val = single_integration::get_partial_custom(IntegrationMethod::GaussLegendre, &func, 0, &integration_limit, &point, 2).unwrap();
    assert!(f64::abs(val - 7.0) < 0.00001);
    ...
    //partial integration for y, known to be 2.0*x*y + y*y*z/2.0, expect a value of ~10.00 
    let val = single_integration::get_partial_custom(IntegrationMethod::GaussLegendre, &func, 1, &integration_limit, &point, 2).unwrap();
    assert!(f64::abs(val - 10.0) < 0.00001);
    ...
    //partial integration for z, known to be 2.0*x*z + y*z*z/2.0, expect a value of ~15.0 
    let val = single_integration::get_partial_custom(IntegrationMethod::GaussLegendre, &func, 2, &integration_limit, &point, 2).unwrap();
    assert!(f64::abs(val - 15.0) < 0.00001);
}
...
fn test_gauss_legendre_quadrature_integration_5()
{
    ...
    //the final point
    let point = std::vec![num_complex::c64(1.0, 0.5), num_complex::c64(2.0, 2.0), num_complex::c64(3.0, 0.0)];
...
fn test_simpsons_integration_1()
{
    ...
    //simple integration for x, known to be x*x, expect a value of ~4.00
    let val = single_integration::get_total_custom(IntegrationMethod::Simpsons, &func, &integration_limit, 200).unwrap();
...
fn test_simpsons_integration_2()
{
    ...
    //partial integration for x, known to be x*x + x*y*z, expect a value of ~7.00
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 0, &integration_limit, &point, 200).unwrap();
    ...
    //partial integration for y, known to be 2.0*x*y + y*y*z/2.0, expect a value of ~10.00 
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 1, &integration_limit, &point, 200).unwrap();
    ...
    //partial integration for z, known to be 2.0*x*z + y*z*z/2.0, expect a value of ~15.0 
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 2, &integration_limit, &point, 200).unwrap();
...
fn test_simpsons_integration_3()
{
    ...
    //simple double integration for 6*x, expect a value of ~24.00
    let val = double_integration::get_total_custom(IntegrationMethod::Simpsons, &func, &integration_limits, 200).unwrap();
...
fn test_simpsons_integration_4()
{
    ...
    //double partial integration for first x then y, expect a value of ~1.50
    let val = double_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, [0, 1], &integration_limits, &point, 200).unwrap();
...
fn test_simpsons_integration_5()
{
    ...
    //simple integration for x, known to be x*x, expect a value of 0.00 + 8.0i
    let val = single_integration::get_total_custom(IntegrationMethod::Simpsons, &func, &integration_limit, 100).unwrap();
...
{ 
    ...
    //partial integration for x, known to be x*x + x*y*z, expect a value of 5.0 + 9.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 0, &integration_limit, &point, 100).unwrap();
    ...
    //partial integration for y, known to be 2.0*x*y + y*y*z/2.0, expect a value of 10.0 + 5.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 1, &integration_limit, &point, 100).unwrap();
    ...
    //partial integration for z, known to be 2.0*x*z + y*z*z/2.0, expect a value of 13.75 + 10.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, 2, &integration_limit, &point, 100).unwrap();
...
fn test_simpsons_integration_7()
{
    ...
    //simple double integration for 6*x, expect a value of 6.0 + 33.0i
    let val = double_integration::get_total_custom(IntegrationMethod::Simpsons, &func, &integration_limits, 20).unwrap();
...
fn test_simpsons_integration_8()
{
    ...
    //double partial integration for first x then y, expect a value of -5.5 + 4.5i
    let val = double_integration::get_partial_custom(IntegrationMethod::Simpsons, &func, [0, 1], &integration_limits, &point, 20).unwrap();
...
fn test_trapezoidal_integration_1()
{
    ...
    //simple integration for x, known to be x*x, expect a value of ~4.00
    let val = single_integration::get_total_custom(IntegrationMethod::Trapezoidal, &func, &integration_limit, 10).unwrap();
    assert!(f64::abs(val - 4.0) < 0.00001);
}
...
fn test_trapezoidal_integration_2()
{
    ...
    //partial integration for x, known to be x*x + x*y*z, expect a value of ~7.00
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 0, &integration_limit, &point, 10).unwrap();
    assert!(f64::abs(val - 7.0) < 0.00001);
    ...
    //partial integration for y, known to be 2.0*x*y + y*y*z/2.0, expect a value of ~10.00 
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 1, &integration_limit, &point, 10).unwrap();
    assert!(f64::abs(val - 10.0) < 0.00001);
    ...
    //partial integration for z, known to be 2.0*x*z + y*z*z/2.0, expect a value of ~15.0 
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 2, &integration_limit, &point, 10).unwrap();
    assert!(f64::abs(val - 15.0) < 0.00001);
}
...
fn test_trapezoidal_integration_3()
{
    ...
    //simple double integration for 6*x, expect a value of ~24.00
    let val = double_integration::get_total_custom(IntegrationMethod::Trapezoidal, &func, &integration_limits, 10).unwrap();
    assert!(f64::abs(val - 24.0) < 0.00001);
}
...
fn test_trapezoidal_integration_4()
{
    ...
    let val = double_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, [0, 1], &integration_limits, &point, 10).unwrap();
...
fn test_trapezoidal_integration_5()
{
    ...
    //simple integration for x, known to be x*x, expect a value of 0.00 + 8.0i
    let val = single_integration::get_total_custom(IntegrationMethod::Trapezoidal, &func, &integration_limit, 100).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re - 0.0) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 8.0) < 0.00001);
}
...
{ 
    ...
    //partial integration for x, known to be x*x + x*y*z, expect a value of 5.0 + 9.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 0, &integration_limit, &point, 100).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re - 5.0) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 9.0) < 0.00001);
    ...
    //partial integration for y, known to be 2.0*x*y + y*y*z/2.0, expect a value of 10.0 + 5.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 1, &integration_limit, &point, 100).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re - 10.0) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 5.0) < 0.00001);
    ...
    //partial integration for z, known to be 2.0*x*z + y*z*z/2.0, expect a value of 13.75 + 10.0i
    let val = single_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, 2, &integration_limit, &point, 100).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re - 13.75) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 10.0) < 0.00001);
}
...
fn test_trapezoidal_integration_7()
{
    ...
    //simple double integration for 6*x, expect a value of 6.0 + 33.0i
    let val = double_integration::get_total_custom(IntegrationMethod::Trapezoidal, &func, &integration_limits, 20).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re - 6.0) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 33.0) < 0.00001);
}
...
fn test_trapezoidal_integration_8()
{
    ...
    //double partial integration for first x then y, expect a value of -5.5 + 4.5i
    let val = double_integration::get_partial_custom(IntegrationMethod::Trapezoidal, &func, [0, 1], &integration_limits, &point, 20).unwrap();
    assert!(num_complex::ComplexFloat::abs(val.re + 5.5) < 0.00001);
    assert!(num_complex::ComplexFloat::abs(val.im - 4.5) < 0.00001);
}
