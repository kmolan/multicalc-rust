...
fn test_booles_integration_1()
{
    ...
    let integrator = Iterative::with_parameters(100, IterativeMethod::Booles);
...
fn test_booles_integration_3()
{
    ...
    let integrator = Iterative::with_parameters(20, IterativeMethod::Booles);
...
fn test_simpsons_integration_1()
{
    ...
    let integrator = Iterative::with_parameters(200, IterativeMethod::Simpsons);
...
fn test_trapezoidal_integration_1()
{
    ...
    let iterator = Iterative::with_parameters(100, IterativeMethod::Trapezoidal);
    let val = iterator.get_single_total(&func, &integration_limit).unwrap();
...
fn test_trapezoidal_integration_3()
{
    ...
    let integrator = Iterative::with_parameters(10, IterativeMethod::Trapezoidal);
...
fn test_error_checking_1()
{
    ...
    let integrator = Iterative::default();
...
fn test_error_checking_2()
{
    ...
    let integrator = Iterative::with_parameters(0, IterativeMethod::Booles);
