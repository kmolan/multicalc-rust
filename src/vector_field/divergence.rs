...
pub fn get_3d_custom<T: ComplexFloat, const NUM_VARS: usize>(vector_field: &[&dyn Fn(&[T; NUM_VARS]) -> T; 3], point: &[T; NUM_VARS], step_size: f64, mode: mode::DiffMode) -> T
{
    return single_derivative::get_partial_custom(vector_field[0], 0, point, step_size, mode)
